                        ...
                        <div class="checkout-billing-details-wrap">
                            ...
                            <div class="billing-form-wrap">
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="text" id="sdt_nguoi_nhan" placeholder="Số điện thoại"
                                        name="sdt_nguoi_nhan" value="<?= $user['so_dien_thoai'] ?>" required />
                                </div>
                                ...
                                <div class="single-input-item">
                                    ...
                                    <input type="text" id="dia_chi_nguoi_nhan" placeholder="Địa chỉ người nhận"
                                        name="dia_chi_nguoi_nhan" value="<?= $user['dia_chi'] ?>" required />
                                </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="">
                                                        ...
                                                        <?php if(!empty($sanPham['mau_sac']) || !empty($sanPham['bien_the_size'])): ?>
                                                        <br>
                                                        <small>
                                                            <?= !empty($sanPham['mau_sac']) ? 'Màu: ' . htmlspecialchars($sanPham['mau_sac']) : '' ?>
